...
public final class WildexKeybinds {
    ...
    @EventBusSubscriber(modid = Wildex.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
    ...
    @EventBusSubscriber(modid = Wildex.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.GAME)
