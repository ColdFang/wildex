...
import de.coldfang.wildex.client.input.WildexKeybinds;
...
public class Wildex {
    ...
    public Wildex(IEventBus modEventBus, ModContainer modContainer) {
        ...
        if (FMLEnvironment.dist == Dist.CLIENT) {
            modEventBus.addListener(WildexKeybinds::registerKeyMappings);
            NeoForge.EVENT_BUS.register(WildexKeybinds.class);
